...
public class ModelSpiderMother extends ModelBase {
	...
	public ModelSpiderMother(float expandAmount) {
		int i = 13;
		...
		this.spiderBody.setRotationPoint(0.0F,  7.75f, 7.0F);
	...
	public void render(float limbSwing, float limbYaw, float limbPitch, float headYaw, float headPitch, float scale) {
		...
		this.spiderBody.render(scale * 1.4f);
